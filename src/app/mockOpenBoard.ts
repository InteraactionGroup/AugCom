...
loadBoard: {name: 'bt1', path: 'bt1'}},
	{id: 'b7', extCboardLabelKey: 'b1', label: 'bt7', backgroundColor: 'red', imageId: 'im2',
loadBoard: {name: 'bt7', path: ''}},
{id: 'b2', extCboardLabelKey: 'root', label: 'bt2', backgroundColor: 'purple', imageId: 'im1',
loadBoard: {name: 'bt2', path: ''}},
{id: 'b3', extCboardLabelKey: 'root', label: 'bt3', backgroundColor: 'pink', imageId: 'im1',
loadBoard: {name: 'bt3', path: ''}},
{id: 'b4', extCboardLabelKey: 'root', label: 'bt4', backgroundColor: 'blue', imageId: 'im1',
